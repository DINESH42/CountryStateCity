    ...
    return (
        <div style={{ backgroundColor: "#adbab8", height: "100vh" }}>
            ...
            <div style={{ width: "100%", display: "flex", flexDirection: "row", flex: 1, justifyContent: "space-evenly", padding: "2rem 1rem" }}>
                <Country setcntryCode={setcntryCode} setStateCityName={setStateCityName} />
            ...
            <span style={{ width: "100%", display: "flex", flexDirection: "row", padding: "2rem 6rem", justifyContent: "center", textAlign: "center", marginTop: "10rem", border: "1px solid gray" }}>City Name :{" " + stateCityName}</span>
        </div>
    )
